...
class step_another4_cls:
    def make_step4_another4(self, number, nbar):
        
        num = number
        
        # 엑셀 파일 열기
        wb = openpyxl.load_workbook('F:/JusikData/analysis_csv/step/step3/another/매도시점교체_'+str(num)+'_'+str(nbar)+'.xlsx')
        ...
        # 저장
        wb.save('F:/JusikData/analysis_csv/step/step3/another/매도시점교체_'+str(num)+'_'+str(nbar)+'.xlsx')
        wb.close()
