...
class dartapi_cvbdIsDecsn_cls():
    def exe_cvbdIs(self, api_key, corpcode, bgn_de, end_de):
        ## 전환사채 발행 결정
        url_json = 'https://opendart.fss.or.kr/api/cvbdIsDecsn.json'
        url_xml = 'https://opendart.fss.or.kr/api/cvbdIsDecsn.xml'
...
conn = dartapi_cvbdIsDecsn_cls()
conn.exe_cvbdIs('471e09c05ab83538cdb861f334fec507d3068573','00138792', '20150101', '20211221')